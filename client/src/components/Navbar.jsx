...
import { Building2, ShieldCheck, UserCheck, Map, PlusCircle } from "lucide-react";
      ...
      <div className="flex items-center justify-between gap-4 h-16 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="hidden sm:inline-flex items-center gap-1 px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-100 rounded-lg transition-all"
          >
          ...
          <button
            ...
            className="hidden lg:inline-flex items-center gap-1.5 px-2.5 py-1 bg-emerald-50 border border-emerald-200/70 rounded-full text-emerald-700 text-[10px] font-bold"
          >
